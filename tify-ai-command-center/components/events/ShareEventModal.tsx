...
export default function ShareEventModal({ isOpen, onClose, event }: ShareEventModalProps) {
  ...
  const baseUrl = typeof window !== 'undefined' ? `${window.location.origin}/events/${event.id}/rsvp` : '';
        ...
        <div className="relative px-8 py-6 bg-gradient-to-r from-pink-600 to-rose-600">
           ...
           <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-pink-100 text-sm font-medium opacity-90">Gestiona los enlaces de invitación</p>
              </div>
           </div>
        </div>
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-left">
                                <span className="block font-bold text-gray-700 text-sm group-hover:text-gray-900">¿Necesitas un enlace general?</span>
                                <span className="block text-xs text-gray-500">Menos seguro, pero útil para grupos grandes.</span>
                            </div>
                        </div>
                         ...
                         <div className="flex items-start justify-between mb-4">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500">Cualquiera con este link puede intentar acceder.</p>
                                </div>
                            </div>
                            <button 
                                ...
                                <div className="flex items-center gap-3 overflow-hidden">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <div className="flex items-center gap-2 text-xs text-gray-500">
                                            ...
                                            {guest.phoneNumber && <span className="truncate">{guest.phoneNumber}</span>}
                                        </div>
                                    </div>
                                </div>

                                <button
                                    onClick={() => copyToClipboard(getGuestLink(guest), guest.id || `idx-${index}`)}
            ...
            <div className="bg-indigo-50 rounded-xl p-4 flex gap-3 border border-indigo-100">
                ...
                <div>
                    ...
                    <p className="text-xs text-indigo-700 leading-relaxed">
                        Los enlaces personalizados precargan los datos del invitado y ofrecen una experiencia VIP. 
                        ¡Úsalos para aumentar la tasa de confirmación!
                    </p>
                </div>
            </div>
