...
export default function GuestRSVP({ eventId }: { eventId: string }) {
  ...
  const handleIdentify = (e: React.FormEvent) => {
    ...
    const found = event.guestList.find(
      (g) =>
              ...
              >
                <div className="text-center mb-4">
                  <p className="text-sm text-gray-600">
                    Para confirmar, ingresa tu número de teléfono o nombre tal como aparece en la
                    invitación.
                  </p>
                </div>
                <div>
            ...
            {view === 'details' && (
              ...
              >
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <CheckCircle
                      className={`w-8 h-8 ${rsvpStatus === 'confirmed' ? 'text-green-600' : 'text-gray-300'}`}
                    />
                  ...
                  >
                    <XCircle
                      className={`w-8 h-8 ${rsvpStatus === 'declined' ? 'text-red-600' : 'text-gray-300'}`}
                    />
