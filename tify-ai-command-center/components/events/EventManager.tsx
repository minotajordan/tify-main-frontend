          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-indigo-100 text-sm font-medium opacity-90">
                Administra la información y estado
              </p>
            </div>
          </div>
        </div>
          ...
          <form id="guest-form" onSubmit={handleSubmit} className="p-8 space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`px-3 py-1 rounded-full text-xs font-bold border uppercase tracking-wide ${getStatusColor(formData.status || 'pending')}`}
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2 group">
                  <label className="text-xs font-semibold text-gray-500 uppercase tracking-wide group-focus-within:text-indigo-600 transition-colors">
                    Nombre Completo
                  </label>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div
                  className={`bg-gradient-to-br p-4 rounded-2xl border flex items-center justify-between group hover:shadow-md transition-shadow ${formData.infoFilled ? 'from-green-50 to-white border-green-100' : 'from-gray-50 to-white border-gray-200'}`}
                >
                  <div>
                    <span
                      className={`text-xs font-semibold uppercase tracking-wide block mb-1 ${formData.infoFilled ? 'text-green-500' : 'text-gray-400'}`}
                    >
                      Formulario
                    </span>
                    <span
                      className={`text-lg font-bold flex items-center gap-2 ${formData.infoFilled ? 'text-green-700' : 'text-gray-500'}`}
                    >
                      {formData.infoFilled ? 'Completado' : 'Pendiente'}
                    </span>
                  </div>
                  <div
                    className={`w-10 h-10 bg-white rounded-xl shadow-sm flex items-center justify-center group-hover:scale-110 transition-transform ${formData.infoFilled ? 'text-green-500' : 'text-gray-400'}`}
                  >
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl p-8 relative animate-in zoom-in-95 duration-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-indigo-700">
              Evento Macro
            </h3>
            <p className="text-gray-500 leading-relaxed">
              Ideal para conciertos, estadios y grandes aforos. Incluye gestión de boletería, pagos,
              diseño de zonas y reserva de sillas.
            </p>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-pink-700">
              Evento Local / Celebración
            </h3>
            <p className="text-gray-500 leading-relaxed">
              Perfecto para cumpleaños, grados y reuniones. Incluye invitaciones personalizadas,
              links únicos, gestión de invitados y plantillas web.
            </p>
            <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
...
export default function EventManager() {
  ...
  const [activeTab, setActiveTab] = useState<
    'info' | 'seats' | 'control' | 'sales' | 'raffle' | 'dashboard' | 'guests'
  >('info');
  ...
  const handleLocalFinalSubmit = async (e: React.FormEvent) => {
    ...
    const processedGuests = guestList.map((g) => ({
      ...
      quota:
        allData.guestsPerInviteMode === 'fixed'
          ...
          {loading ? (
            ...
            <div className="text-center py-20 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
              ...
              <p className="text-gray-500 mb-6">
                Comienza creando tu primer evento para gestionar el aforo.
              </p>
              <button
                    ...
                    {showQrFor === event.id && (
                      <div className="absolute top-10 right-0 bg-white p-4 rounded-xl shadow-xl border border-gray-100 w-64 animate-in fade-in zoom-in duration-200 z-20">
                        ...
                        <div className="bg-white p-2 rounded-lg border border-gray-100 flex justify-center mb-3">
                          <QRCodeSVG
                            value={`http://localhost:3000/events/${event.id}/public`}
                            size={150}
                          />
                        </div>
                        <p className="text-xs text-center text-gray-500 mb-3">
                          Escanea para acceder al flujo de compra
                        </p>
            ...
            <form onSubmit={handleCreateEvent} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                  placeholder="Ej: Concierto, Rock, Aire Libre (separadas por coma)"
                />
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Información de Pagos / Boletería
                </label>
                <textarea
                  name="paymentInfo"
                  rows={2}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                  placeholder="Detalles sobre precios, cuentas bancarias o métodos de pago..."
                />
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="bg-gray-50 px-8 py-4 border-b border-gray-200 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 text-sm">
                <span
                  className={`px-2 py-1 rounded ${localStep >= 1 ? 'bg-pink-100 text-pink-700 font-bold' : 'text-gray-400'}`}
                >
                  1. Info
                </span>
                <span className="text-gray-300">→</span>
                <span
                  className={`px-2 py-1 rounded ${localStep >= 2 ? 'bg-pink-100 text-pink-700 font-bold' : 'text-gray-400'}`}
                >
                  2. Configuración
                </span>
                <span className="text-gray-300">→</span>
                <span
                  className={`px-2 py-1 rounded ${localStep >= 3 ? 'bg-pink-100 text-pink-700 font-bold' : 'text-gray-400'}`}
                >
                  3. Invitados
                </span>
              </div>
            ...
            <div className="p-8">
              {localStep === 1 && (
                ...
                >
                  <div>
                    ...
                    <input
                      required
                      defaultValue={localEventData.title}
                      name="title"
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      Descripción / Mensaje para invitados
                    </label>
                    <textarea
                      defaultValue={localEventData.description}
                      name="description"
                      rows={3}
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
                      placeholder="¡Ven a celebrar conmigo!..."
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        required
                        defaultValue={localEventData.startDate}
                        name="startDate"
                        type="datetime-local"
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
                      />
                    ...
                    <div>
                      ...
                      <input
                        required
                        defaultValue={localEventData.endDate}
                        name="endDate"
                        type="datetime-local"
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
                      />
                  ...
                  <div>
                    ...
                    <input
                      required
                      defaultValue={localEventData.location}
                      name="location"
                      type="text"
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
                      placeholder="Ej: Casa de Juan / Salón Social"
                    />
                  </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <label className="flex items-start gap-3 p-3 border rounded-lg cursor-pointer hover:bg-pink-50 transition-colors">
                          <input
                            ...
                            value="private_link"
                            defaultChecked={
                              !localEventData.privacy || localEventData.privacy === 'private_link'
                            }
                            className="mt-1 text-pink-600 focus:ring-pink-500"
                          />
                          <div>
                            ...
                            <span className="text-sm text-gray-500">
                              Solo accesible para quienes tengan el link.
                            </span>
                          </div>
                        </label>
                        <label className="flex items-start gap-3 p-3 border rounded-lg cursor-pointer hover:bg-pink-50 transition-colors">
                          <input
                            ...
                            defaultChecked={localEventData.privacy === 'private_password'}
                            className="mt-1 text-pink-600 focus:ring-pink-500"
                          />
                          <div>
                            <span className="block font-medium text-gray-900">
                        ...
                        {guestsPerInviteMode === 'fixed' ? (
                          <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1">
                              Cuántas personas pueden entrar con una sola invitación.
                            </p>
                          </div>
                        ) : (
                          <div className="p-3 bg-pink-50 text-pink-700 rounded-lg text-sm border border-pink-100">
                            Se tomará el valor de la columna <strong>Cupos</strong> en tu archivo de
                            invitados.
                            <input type="hidden" name="guestsPerInvite" value="1" />{' '}
                            {/* Fallback */}
                          </div>
                        )}
                      </div>
                          ...
                          <div className="border-2 border-gray-200 rounded-xl overflow-hidden peer-checked:border-pink-500 transition-all">
                            ...
                            <div className="p-3 bg-white">
                              ...
                              <span className="text-xs text-gray-500">
                                Perfecto para bodas, 15 años y galas.
                              </span>
                            </div>
                          </div>
                        </label>
                        ...
                        <label className="cursor-pointer group">
                          ...
                          <div className="border-2 border-gray-200 rounded-xl overflow-hidden peer-checked:border-pink-500 transition-all">
                            ...
                            <div className="p-3 bg-white">
                              ...
                              <span className="text-xs text-gray-500">
                                Ideal para cumpleaños, asados y reuniones.
                              </span>
                            </div>
                          </div>
                        </label>
              ...
              {localStep === 3 && (
                <form
                  onSubmit={handleLocalFinalSubmit}
                  className="space-y-8 animate-in slide-in-from-right-8 duration-300"
                >
                  ...
                  <div className="bg-pink-50 border border-pink-100 rounded-lg p-6">
                    ...
                    <p className="text-sm text-pink-700 mb-4">
                      Gestiona tu lista de invitados. Puedes subirlos masivamente o agregarlos uno a
                      uno.
                    </p>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <input
                              ...
                              onChange={(e) =>
                                setManualGuest((prev) => ({ ...prev, name: e.target.value }))
                              }
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setManualGuest((prev) => ({ ...prev, phoneNumber: e.target.value }))
                              }
                              className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500"
                            />
                            <input
                                ...
                                <tr key={idx} className="hover:bg-gray-50">
                                  <td className="px-4 py-2">
                                    ...
                                    {guest.additionalData &&
                                      Object.keys(guest.additionalData).length > 0 && (
                                  ...
                                  <td className="px-4 py-2">
                                    <span
                                      className={`px-2 py-0.5 rounded-full text-xs ${guest.status === 'confirmed' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`}
                                    >
                        ...
                        <label className="cursor-pointer">
                          ...
                          <div className="p-4 border rounded-xl hover:bg-gray-50 peer-checked:border-pink-500 peer-checked:bg-pink-50 transition-all text-center h-full">
                            ...
                            <p className="text-xs text-gray-500">
                              Asigna cupos fijos según la lista subida.
                            </p>
                          </div>
                        </label>
                        <label className="cursor-pointer">
                          ...
                          <div className="p-4 border rounded-xl hover:bg-gray-50 peer-checked:border-pink-500 peer-checked:bg-pink-50 transition-all text-center h-full">
                            ...
                            <p className="text-xs text-gray-500">
                              El sistema distribuye mesas automáticamente.
                            </p>
                          </div>
                        </label>
                        <label className="cursor-pointer">
                          ...
                          <div className="p-4 border rounded-xl hover:bg-gray-50 peer-checked:border-pink-500 peer-checked:bg-pink-50 transition-all text-center h-full">
                            ...
                            <p className="text-xs text-gray-500">
                              Confirmas cada reserva manualmente.
                            </p>
                          </div>
                        </label>
                      </div>
                  ...
                  <div className="pt-4 flex justify-end gap-3 border-t border-gray-100">
                    ...
                    <button
                      type="submit"
                      className="px-6 py-2 bg-pink-600 text-white rounded-lg hover:bg-pink-700 font-bold shadow-lg shadow-pink-200 transform hover:scale-105 transition-all"
                    >
    ...
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="border-b border-gray-200 px-6">
        <div className="flex gap-6">
          {selectedEvent?.categories?.includes('LOCAL') ||
          selectedEvent?.categories?.includes('CELEBRACION') ? (
            <>
              <button
      ...
      <div className="flex-1 overflow-hidden bg-gray-50">
        ...
        {activeTab === 'sales' && selectedEvent && <SalesDetails eventId={selectedEvent.id} />}
        {activeTab === 'raffle' && selectedEvent && <RaffleSystem eventId={selectedEvent.id} />}
        {activeTab === 'info' && (
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setEditForm({ ...editForm, status: e.target.value as EventStatus })
                        }
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                      >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setEditForm({ ...editForm, privacy: e.target.value as any })
                            }
                        ...
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setEditForm({ ...editForm, reservationMode: e.target.value as any })
                            }
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500"
                          >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setEditForm({
                                ...editForm,
                                guestsPerInvite: parseInt(e.target.value),
                              })
                            }
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500"
                          />
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-pink-50 p-4 rounded-lg space-y-2 border border-pink-100">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <span className="font-medium text-gray-900">
                            {selectedEvent.privacy === 'public'
                              ? 'Público'
                              : selectedEvent.privacy === 'private_password'
                                ? 'Privado con clave'
                                : 'Privado (Link)'}
                          </span>
                        </div>
                        <div>
                          ...
                          <span className="font-medium text-gray-900">
                            {selectedEvent.reservationMode === 'random'
                              ? 'Aleatoria'
                              : selectedEvent.reservationMode === 'manual'
                                ? 'Manual'
                                : 'Predeterminada'}
                          </span>
                        </div>
                        <div>
                          ...
                          <span className="font-medium text-gray-900">
                            {selectedEvent.guestsPerInvite || 1}
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 mt-1 whitespace-pre-wrap">
                      {selectedEvent?.paymentInfo || 'No configurada'}
                    </p>
                  </div>
                </div>
              )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
                      ...
                      <div className="text-xs text-gray-500 mt-1">
                        {viewedGuests.length} han visto la invitación (
                        {totalGuests > 0
                          ? Math.round((viewedGuests.length / totalGuests) * 100)
                          : 0}
                        %)
                      </div>
                    </div>
                    ...
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
                      ...
                      <div className="text-xs text-gray-500 mt-1">Esperando respuesta</div>
                    </div>
                    ...
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
                      ...
                      <div className="text-xs text-gray-500 mt-1">No asistirán</div>
                    </div>
                  </div>
                        ...
                        <div>
                          ...
                          <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${totalQuota > 0 ? (confirmedQuota / totalQuota) * 100 : 0}%`,
                              }}
                            />
                          </div>
                        </div>
                        <div>
                          <div className="flex justify-between text-sm mb-2">
                            ...
                            <span className="font-bold text-gray-900">
                              {totalGuests > 0
                                ? Math.round(
                                    ((confirmedGuests.length + declinedGuests.length) /
                                      totalGuests) *
                                      100
                                  )
                                : 0}
                          ...
                          <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${totalGuests > 0 ? ((confirmedGuests.length + declinedGuests.length) / totalGuests) * 100 : 0}%`,
                              }}
                            />
                          </div>
                        </div>
                                    ...
                                    <div className="text-xs text-gray-500">
                                      {guest.updatedAt
                                        ? new Date(guest.updatedAt).toLocaleDateString() +
                                          ' ' +
                                          new Date(guest.updatedAt).toLocaleTimeString([], {
                                            hour: '2-digit',
                                            minute: '2-digit',
                                          })
                                        : 'Reciente'}
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setManualGuest((prev) => ({ ...prev, quota: parseInt(e.target.value) }))
                      }
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                    />
                  </div>
                ...
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Sube un archivo CSV con la lista de tus invitados.
                    </p>
                  </div>
                  <button
                    onClick={downloadTemplate}
                    ...
                    onChange={(e) => {
                      ...
                      if (file) {
                        ...
                        reader.onload = (event) => {
                          ...
                          // Auto-save to API
                          api
                            .updateEvent(updatedEvent.id, { guestList: updatedEvent.guestList })
                            .catch(console.error);

                          alert(
                            `Se han importado ${processedGuests.length} invitados correctamente.`
                          );
                        };
                        reader.readAsText(file);
                      }
                    ...
                    {(!selectedEvent.guestList || selectedEvent.guestList.length === 0) && (
                      <tr>
                        <td colSpan={6} className="p-12 text-center text-gray-500">
                          ...
                          <p className="text-sm text-gray-500">
                            Comienza agregando invitados manualmente o importa una lista CSV.
                          </p>
                        </td>
                      </tr>
                    )}
                      ...
                      >
                        ...
                        <td className="p-1">
                          ...
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              const newGuestList = selectedEvent.guestList?.filter(
                                (_, i) => i !== idx
                              );
                              ...
                              setEvents(events.map((e) => (e.id === updated.id ? updated : e)));
                              api
                                .updateEvent(updated.id, { guestList: newGuestList })
                                .catch(console.error);
                            }}
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex flex-col h-full overflow-hidden">
                ...
                <div className="w-full flex flex-col items-center border-2 border-dashed border-gray-200 rounded-xl bg-gray-50 mb-6 p-6 flex-shrink-0">
                  ...
                  <p className="text-sm text-gray-500 text-center mb-4">
                    Escanea el código QR del asistente o ingresa el código manual
                  </p>
                  ...
                  <div className="overflow-y-auto flex-1 space-y-2 pr-2">
                    {liveStats?.recentSales?.length ? (
                      liveStats.recentSales.map((sale) => (
                        <div
                          key={sale.id}
                          className="bg-green-50 text-green-700 p-3 rounded-lg text-sm flex justify-between items-center"
                        >
                          ...
                          <span className="text-xs font-bold">
                            {new Date(sale.purchaseDate).toLocaleTimeString()}
                          </span>
                        </div>
                      ))
                    ) : (
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="p-4 bg-gray-50 rounded-xl">
                      <div className="text-2xl font-bold text-gray-600">
                        {liveStats &&
                        liveStats.revenueByZone.reduce((acc, z) => acc + z.capacity, 0) > 0
                          ? Math.round(
                              (liveStats.ticketsSold /
                                liveStats.revenueByZone.reduce((acc, z) => acc + z.capacity, 0)) *
                                100
                            )
                          : 0}
                        %
                        ...
                        <div key={zone.id}>
                          ...
                          <div className="w-full bg-gray-100 rounded-full h-2">
                            <div
                              ...
                              style={{
                                width: `${percentage}%`,
                                backgroundColor: originalZone?.color || '#4f46e5',
                              }}
                            ></div>
                          </div>
                        </div>
